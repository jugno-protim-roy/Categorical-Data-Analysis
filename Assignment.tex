...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=north, align=center] at ([yshift=-4cm]current page.north) {
        ...
        {\color{Charcoal}\Large \textit{COURSE CODE:}STAT-4104}\\[0.8cm]
...
\node[anchor=north east, align=left] at ([xshift=-1cm, yshift=-2cm]current page.center) {
    ...
    \textbf{\color{Charcoal}Name:} JUGNO PROTIM ROY \\[0.2cm]
    \textbf{\color{Charcoal}ID:} 12110068 \\[0.2cm]
    \textbf{\color{Charcoal}Reg No:} 000015931 \\[0.2cm]
...
\node[anchor=north west, align=left] at ([xshift=1cm, yshift=-2cm]current page.center) {
    ...
    \node[anchor=south] at ([yshift=2cm]current page.south) {
        {\color{Charcoal}\large \textsc{Date of Submission: May 18, 2026}}
    };
\end{tikzpicture}
