...
\begin{center}
    ...
    \begin{tabular}{p{0.85\textwidth} r}
        ...
        \textbf{\color{RoyalNavy}Problem 5:} Logistic Regression GLM - Graduate School Admission & 13 \\
        \textbf{\color{RoyalNavy}Problem 6:} Poisson Regression GLM - Number of Awards & 15 \\
        \textbf{\color{RoyalNavy}Problem 7:} Negative Binomial Regression - Days Absent & 16 \\
        \textbf{\color{RoyalNavy}Problem 8:} Zero-Inflated Poisson Regression - Fish Catch Data & 17 \\
        \textbf{\color{RoyalNavy}Problem 9:} Zero-Inflated Poisson - Detailed Analysis & 19 \\
        \textbf{\color{RoyalNavy}Problem 10:} Zero-Truncated Poisson - Hospital Length of Stay & 21 \\
        \textbf{\color{RoyalNavy}Problem 11:} Zero-Truncated Negative Binomial - Hospital Stay & 23 \\
    \end{tabular}
    \vspace{0.5cm}
    \end{tcolorbox}
\end{center}
